...
public class Nine {
  ...
  public void test2() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.sprite.sprite-logo")).click();
    ...
    driver.findElement(By.cssSelector("button.dropdown-toggle.js-listview-actions")).click();
    driver.findElement(By.cssSelector("button.js-listview-refresh")).click();
